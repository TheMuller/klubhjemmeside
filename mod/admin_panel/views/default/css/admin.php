...
.elgg-list > li .elgg-body ul.elgg-plugin-resources {
	padding-right: 0 !important;
	margin: 0 !important;
}
#elgg-plugin-list .elgg-list > li .elgg-body ul,
#elgg-plugin-list .elgg-list > li .elgg-body ul > li,
#elgg-plugin-list .elgg-list li .elgg-body > div.pts {
	float: left;
}
#elgg-plugin-list .elgg-list > li .elgg-body ul > li,
#elgg-plugin-list .elgg-list li .elgg-body > div.pts {
...
#elgg-plugin-list .elgg-list > li .elgg-body ul > li:after {
	padding-left: 10px; 
	content: "\2022"; 
}
