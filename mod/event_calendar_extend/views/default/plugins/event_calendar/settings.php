...
$body .= '<br /><hr size=5 color=blue noshade>';
...
$body .= elgg_echo('Event Currency: ('.$event_calendar_currency.') &nbsp; &nbsp; &nbsp; ');	//:DC:
//$body .= '<br />';
/**$body .= elgg_view(
	'input/text',
	array('
		name'=>'params[currency]',
		'value'=>$event_calendar_currency
	)
);**/
$CurrOptions=array(	//:DC:
	'DKK'=>' DKK ',
/**	'Denmark DKK Danish Krone'=>' DKK kr ',
	'Europe EUR Euro'=>' EUR € ',
...
if(!$event_calendar_currency)	//:DC:
	$event_calendar_currency='Denmark DKK Danish Krone';//:DC: ?DEFAULT?	//:DC:
$currency_input = elgg_view('input/dropdown', array(	//:DC:
	'class' => 'CurrFont',
	'name'=>'params[currency]',
	'id' => 'params[currency]',
	'value' => $event_calendar_currency,
