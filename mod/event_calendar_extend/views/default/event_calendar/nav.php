...
switch($vars['filter']) {
	case 'past':		$pastselect = 'class="selected"';
					break;
...
?>
		...
		<li <?php echo $pastselect; ?>    ><a onclick="javascript:$('#event_list').load('<?php echo $url_start; ?>&amp;filter=mine&amp;callback=true'); return false;" href="<?php echo $url_start; ?>&amp;filter=past&amp;callback=true"><?php echo elgg_echo('event_calendar:past'); ?></a></li>
	</ul>
</div>
<?php
