...
$tabs = array(
	'all' => array(
		...
		'href' => "$url_start/all",		'selected' => ($filter_context == 'all'),	  'priority' => 200,	),
	'mine' => array(
		'text' => elgg_echo('event_calendar:show_mine'),
		'href' => "$url_start/mine",	'selected' => ($filter_context == 'mine'),	  'priority' => 300,	),
	'friend' => array(
		'text' => elgg_echo('event_calendar:show_friends'),
		'href' =>  "$url_start/friends",'selected' => ($filter_context == 'friends'), 'priority' => 400,	),
	'past' => array(							//:DC:		
		'text' => elgg_echo('event_calendar:show_past'),	
		'href' =>  "$url_start/all/-/pastevents",	'selected' => ($filter_context == 'past'),	  'priority' => 500,	),
);
