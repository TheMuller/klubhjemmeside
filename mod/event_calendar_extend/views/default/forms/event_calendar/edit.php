...
$personal_manage_options = array(
	...
	elgg_echo('event_calendar:personal_manage:closedfuture_keep_list') => 'closedfuture_keep_list',
	elgg_echo('event_calendar:personal_manage:closedfuture_no_list') => 'closedfuture_no_list',
...
$all_fields = array('title','venue','start_time','start_date','end_time','end_date',
	'brief_description','region','event_type','contact','organiser','event_tags',
	'long_description','personal_manage');
...
{//:DC:
	...
	$body .= elgg_view("input/radio",
		array(
			...
			'options'=>$personal_manage_options
		)
	);
	$body .= '</label></p>';
...
$body .= elgg_view("input/ticket_options",array('name' => 'ticket_options','entity'=>$event));
