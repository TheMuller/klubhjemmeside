...
?> 
	...
	<h2 style="border-bottom: 1px solid #CCCCCC;margin:10px;">General Settings</h2>
		...
		<?php
                $social_login_notify = elgg_get_plugin_setting("social_login_notify","social_login");
		echo "<strong>";
                echo elgg_echo('social:login:notify');
		echo "</strong>";
                echo elgg_view("input/dropdown", array("name" => "params[social_login_notify]", "value" => $vars['entity']->social_login_notify, "options_values" => $noyes_options));
                echo '<br><br>';
                echo "This is the default message that will be sent. You can change it in the language file: ";
                echo "<strong>";
                echo elgg_echo('social:register:joined');
                echo "</strong>";
                echo '<br>';
		?>
		</table>
