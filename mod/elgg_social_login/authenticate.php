...
<table width="100%" border="0">
  <tr>
    <td align="center" height="200px" valign="middle"><img src="<?php echo $assets_base_url ; ?>graphics/ajax_loader.gif" /></td>
  </tr>
  <tr>
	...
	if( isset( $_GET["provider"] ) && isset( $_GET["redirect_to_provider"] )){
		try{ 
			...
			# {{{ update user profile
				...
				// 2. Brief description
				create_metadata( $user->guid, "briefdescription", html_entity_decode( substr ($user_profile->briefdescription,0, 197), ENT_COMPAT, 'UTF-8'), "text", $user->guid, 1 );
