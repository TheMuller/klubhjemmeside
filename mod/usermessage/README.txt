...
$param = array(
		...
		'form_params'=>array(),
		'body_params'=>array(),
		'username' => 'sachin',  //Only useful if 'when' => 'nextlogin'
		'when' =>'thispage OR nextlogin OR thissession',
		'where' => 'relative/Path', //for ex. 'groups/all' //If empty or absent then visible every where in the site
         );
    
create_user_message("create",'some_unique_string',$param );
